    ...
    <body>
        ...
        <div class="container-flex">
            <div class="row justify-content-around">
                ...
                $productsWithoutGluten = $db->getAllProductsWihtoutGluten();

                $imgProductsWithoutGluten = $db->getImgfromProductsWihoutGluten();

                foreach ($productsWithoutGluten as $v) {

                    foreach ($imgProductsWithoutGluten as $i) {
